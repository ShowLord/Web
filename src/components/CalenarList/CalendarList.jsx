...
export default function CalendarList(props) {
  const {
    title, color, isChecked, getCheckedStatus, index, allPlanList, calendarId,
  } = props;
  ...
  const progressColor = color.replace(')', ',0.3)');
  ...
  return (
    <div className="calendar-card">
      <div className="boxTrigger pointer" onClick={onToggle}>
        ...
        <svg className={classNames('checked', { active: toggle })} width="31" height="24" viewBox="0 0 31 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="content">
        ...
        <svg className="edit" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
