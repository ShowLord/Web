...
export default function EditCalendarForm(props) {
  const { editCalendarWindow, getEditCalendarInfo, editTarget } = props;
  const [color, setColor] = useState(editTarget.color);

  console.log(editTarget.color);
  ...
  return (
    <div className="mask" onClick={closeItem}>
      <div className="calendar-window edit">
        <svg className="close pointer" onClick={closeItem} viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="form">
          <div className="section">
            <span> 編輯日曆</span>
            <svg className="del pointer" onClick={() => alert('還沒做')} viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
